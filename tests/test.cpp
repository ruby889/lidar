...
void readFile(){
    // ifstream f("/home/ruby/lidar/YDLidar-SDK-master/scan_pts.txt");
...
int main(int argc, char *argv[])
{
    ...
    while (getEulerDistance(robot, target) > d){
        ...
        plt::tight_layout();
        plt::show(); 
        // std::string image_name = "C:\\Users\\ruby\\Desktop\\lidar\\YDLidar-SDK-master\\samples\\images\\" + std::to_string(image_i) + ".png";
        // plt::save(image_name);
        // image_i++;
    }
